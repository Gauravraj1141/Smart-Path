...
const OtpVerification = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            ...
            axios.post("http://127.0.0.1:8000/auth/verify_user_otp/", {
                ...
                <form action="" className="space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-1 text-sm">
                        <label className="block text-xl text-black">
                            OTP<span className="text-red-600 font-semibold text-md"></span>
                        </label>
                        <input
                            type="otp"
                            name="otp"
                    ...
                    <div>
                        ...
                        {loader && (<svg aria-hidden="true" className="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
